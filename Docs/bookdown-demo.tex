...
This document is hosted with the rest of the project in the {[}ltaylor2/finalproject{]})(\url{https://github.com/ltaylor2/finalproject} ``GitHub Repository Link'') respository. The document is statically rendered to host at this url.
