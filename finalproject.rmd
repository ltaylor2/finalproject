...
cat("\tTaxLabels ", paste(stageData$Taxon, collapse=" "), ";\n", sep="")
cat("End;\n")

cat("Begin CHARACTERS;\n")
cat("\tDimensions NCHAR=", ncharacters, ";\n", sep="")
cat("\tFormat DataType=Standard Symbols=\"0 1 2 3\";\n", sep="")
cat("\tCharLabels ", paste(colnames(stageData)[-1], collapse=" "), ";\n", sep="")
cat("\tMatrix", sep="")

for (r in 1:nrow(stageData)) {
  taxon <- stageData$Taxon[r]
  characters <- paste(stageData[r, -1], collapse="")
  cat("\n\t\t", taxon, " ", characters)
}
cat(";\n")
cat("End;")
...
lambda_stages ~ dnExponential(1.0)
mu_stages ~ dnExponential(1.0)
Q_stages <- fnOrderedRateMatrix(3, lambda_stages, mu_stages)
```
